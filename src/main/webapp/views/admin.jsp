...
<div class="opstion">
  ...
  <section>
    ...
    <p class="fw-bold">
      Tên người dùng: 
      <br>
      <input type="text" value="Người dùng 1">
    </p>

    <p class="fw-bold">
      Email: 
      <br>
      <input type="text" value="user1@example.com">
    </p>

    <p class="fw-bold">
      Vai trò: 
      <br>
      <input type="text" value="Người dùng">
    </p>
  </section>
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>Người dùng</td>
          <th><button type="button" class="btn btn-success"><i class="bi bi-pencil-fill"></i></button></th>
        </tr>
        <tr>
          <td>Người dùng 2</td>
